  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      theme: ThemeData(
        ...
        useMaterial3: true, // Включить Material 3 дизайн
      ),
      darkTheme: ThemeData(
      ...
      themeMode: ThemeMode.system, // Следовать системным настройкам темы
      home: const Scaffold( // Временный экран-заглушка
        body: Center(
